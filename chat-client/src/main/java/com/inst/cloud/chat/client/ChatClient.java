package com.inst.cloud.chat.client;



import com.inst.cloud.chat.client.handler.ChatClientHandler;
...
public class ChatClient {
    ...
    public ChatClient(){
        this.clientHandler = new ChatClientHandler();
    }
...
//        new ChatClient("Cover").connect("127.0.0.1",80);
        new ChatClient().connect("127.0.0.1",80);
    }
}
